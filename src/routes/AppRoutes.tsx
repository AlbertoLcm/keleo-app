...
import { GoogleSuccess, LoginPage, SignupPage, VerifyEmail, ForgotPasswordPage, ResetPasswordPage } from "@/modules/auth";
import PublicRoute from "./PublicRoute";
import ProtectedRoute from "./ProtectedRoute";
import { RoleProtectedRoute } from "./RoleProtectedRoute";
import { IndexRedirect } from "./IndexRedirect";
import { HeaderActionProvider, LayoutSidebar, NotFoundPage } from "@/modules/shared";
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path={ROUTES.ORDERS.INDEX}>
            <Route index element={
              <RoleProtectedRoute allowedRoles={['owner', 'admin', 'manager', 'cashier', 'waiter']}>
                <OrdersPage />
              </RoleProtectedRoute>
            } />
