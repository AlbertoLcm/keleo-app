...
import { Bell, Lock, Smartphone, Camera, User, CreditCard, Sparkles, Mail, Sun, Moon, Monitor } from "lucide-react";
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-dark-card rounded-2xl p-6 border border-gray-100 dark:border-white/5 shadow-sm">
              ...
              <div className="flex items-center justify-between py-3">
                ...
                <div className="flex items-center bg-gray-100 dark:bg-white/5 rounded-lg p-1 gap-0.5">
                  <button
