...
type ValidStatus = "free" | "occupied" | "payment" | "reserved" | string;
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-base md:text-xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
            {title}
            {config && <StatusBadge color={config.color as StatusBadgeColor} text={config.label} />}
          </h1>
          {subtitle && (
